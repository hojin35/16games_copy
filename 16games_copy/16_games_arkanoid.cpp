...
int main()
{
	...
	Texture t1, t2, t3, t4;
	t1.loadFromFile("C:/16_Games/03 Arkanoid/images/block01.png");
	t2.loadFromFile("C:/16_Games/03 Arkanoid/images/background.jpg");
	t3.loadFromFile("C:/16_Games/03 Arkanoid/images/ball.png");
	t4.loadFromFile("C:/16_Games/03 Arkanoid/images/paddle.png");
	...
	while (app.isOpen())
	{
		...
		//벡터가 아니라 그냥 move(x,y) 만큼 움직이는거 였음...
		sBall.move(dx, 0);
		for (int i = 0; i < n; i++)
		{
